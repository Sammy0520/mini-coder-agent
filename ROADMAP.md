...
- [ ] 由仓库所有者确认并创建 `v0.1.0` tag/Release。
...
3. 当前只保留三个发布决策：许可证、GitHub description/topics，以及是否创建 `v0.1.0` tag/Release；这些由仓库所有者确认。
4. 发布后进入阶段 I2 未知任务盲测，再根据成功率、无关修改、工具调用、token 和耗时选择一项阶段 I3 效率优化。
